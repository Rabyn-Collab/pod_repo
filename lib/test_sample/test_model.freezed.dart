...
class _$TestModelImpl implements _TestModel {
  const _$TestModelImpl(
      {required this.desc, required this.completed, required this.id});
  ...
  @override
  String toString() {
    return 'TestModel(desc: $desc, completed: $completed, id: $id)';
  }
...
abstract class _TestModel implements TestModel {
  const factory _TestModel(
      ...
      required final String id}) = _$TestModelImpl;
